...
>
  ...
  Student Q&A
          ...
          <p className="text-sm text-gray-500 mt-1">Questions asked by enrolled students are listed here for instructor replies.</p>
        </div>
        ...
        <div className="p-5 sm:p-8 space-y-4">
          {courseQuestions.length === 0 ? (
            ...
            courseQuestions.map((question) => (
              <div key={question.id} className="rounded-xl border p-4 sm:p-5 bg-gray-50">
                <div className="flex items-center justify-between gap-3 flex-wrap">
                  <p className="font-semibold text-gray-900">Lesson Q: {question.question}</p>
                  {question.answer ? (
  ...
  Pending
                ...
                <p className="mt-3 text-sm text-gray-700">
                  {question.answer ? `Instructor Reply: ${question.answer}` : 'Awaiting instructor reply.'}
                </p>
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-3">
                  <textarea
                    ...
                    className="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 outline-none"
                  />
                  <Button {...{
                    type: "button",
                    className: "sm:w-auto",
